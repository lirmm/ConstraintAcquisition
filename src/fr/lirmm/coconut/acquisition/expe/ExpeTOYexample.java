 ...
 * @author NADJIB
 */
public class ExpeTOYexample extends DefaultExperience{

	boolean auto_learn;
	private int nb_vars=5;
	private static boolean gui=true;
	private static boolean parallel=true;
	public ExpeTOYexample(boolean auto_learn) {
	...
	public ACQ_ConstraintSolver createSolver() {
		...
		},vrs.BiasDeg.toString(),vls.IntDomainRandom.toString());
	}
