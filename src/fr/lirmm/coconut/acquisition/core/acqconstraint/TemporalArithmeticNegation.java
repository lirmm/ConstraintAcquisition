 ...
 * @author agutierr
 */
public class TemporalArithmeticNegation extends TemporalConstraint {
	 ...
	 */
	public TemporalArithmeticNegation(String name, ACQ_TemporalVariable var1, Operator op, ACQ_TemporalVariable var2,
	...
	/**
	 * Returns a new TemporalArithmetic constraint which is the negation of this
	 * constraint By instance, a constraint with "=" as operator will return a new
	 * constraint with the same variables but with "!=" as operator
	 * 
	 * @return A new TemporalArithmetic constraint, negation of this constraint
	 */
	@Override
	public TemporalArithmetic getNegation() {

		String negationName = this.getNegName();
		if (negationName.equals("UNKNOWN"))
			negationName = "not_" + getName();

		return new TemporalArithmetic(negationName, tempvariables[0], Operator.getOpposite(op1), tempvariables[1],
				this.conjunction, Operator.getOpposite(op2), this.getName(),inverse);
	...
	public Constraint[] getChocoConstraints(Model model, IntVar... intVars) {
		...
		if (conjunction) {
			part1 = model.arithm(endx,  Operator.getOpposite(op2).toString(), endy);
			part2 = model.arithm(startx, Operator.getOpposite(op1).toString().toString(), starty);
			
			cst = model.or(part1, part2,part3,part4);
		} else {
			cst = model.or(part3,part4,model.arithm(endx, Operator.getOpposite(op1).toString(), starty));
		}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TemporalArithmeticNegation other = (TemporalArithmeticNegation) obj;
		if (cste != other.cste)
			return false;
	...
	public TemporalArithmeticNegation getInverse() {
		switch(name) {
		case "PrecedesXY":
			return new TemporalArithmeticNegation("IsPrecededXY", tempvariables[1], op1,
					tempvariables[0], this.conjunction,op2, this.getName(),true);
		case "IsPrecededXY":
			return new TemporalArithmeticNegation("PrecedesXY", tempvariables[0], op1,
					tempvariables[1], this.conjunction,op2, this.getName(),false);

		case "MeetsXY":
			return new TemporalArithmeticNegation("IsMetXY", tempvariables[1], op1,
					tempvariables[0], this.conjunction,op2, this.getName(),true);
		case "IsMetXY":
			return new TemporalArithmeticNegation("MeetsXY", tempvariables[0], op1,
					tempvariables[1], this.conjunction,op2, this.getName(),false);
	
		case "StartsXY":
			return new TemporalArithmeticNegation("IsStartedXY", tempvariables[1], op1,
					tempvariables[0], this.conjunction,op2, this.getName(),true);
		case "IsStartedXY":
			return new TemporalArithmeticNegation("StartsXY", tempvariables[0], op1,
					tempvariables[1], this.conjunction,op2, this.getName(),false);
		case "DuringXY":
			return new TemporalArithmeticNegation("ContainsXY", tempvariables[1], op1,
					tempvariables[0], this.conjunction,op2, this.getName(),true);
		case "ContainsXY":
			return new TemporalArithmeticNegation("DuringXY", tempvariables[0], op1,
					tempvariables[1], this.conjunction,op2, this.getName(),false);
		case "FinishXY":
			return new TemporalArithmeticNegation("IsFinishedXY", tempvariables[1], op1,
					tempvariables[0], this.conjunction,op2, this.getName(),true);
		case "IsFinishedXY":
			return new TemporalArithmeticNegation("FinishXY", tempvariables[0], op1,
					tempvariables[1], this.conjunction,op2, this.getName(),false);
		case "ExactXY":
			return new TemporalArithmeticNegation("ExactXY", tempvariables[0], op1,
					tempvariables[1], this.conjunction,op2, this.getName(),false);
