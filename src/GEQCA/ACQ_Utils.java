...
public class ACQ_Utils {
	...
	public static Collective_Stats executeTACQExperience(IExperience expe) {
		...
		LearningQCN acquisition = new LearningQCN(solver, L, target,learner,bias.getVars().size()/2, heuristic);
		// Param
	...
	public static Collective_Stats executeGEQCAExperience(IExperience expe) {
		...
		GEQCA acquisition = new GEQCA(solver, L, target,learner,bias.getVars().size()/2, heuristic);
		// Param
